...
namespace JiongXiaGu.Unity.RectMaps
{
    ...
    {
        private ReaderWriterLockSlim asyncLock;
        private Dictionary<TKey, TValue> dictionary;
        private ICollection<IObserver<DictionaryEvent<TKey, TValue>>> observers;
        ...
        public void Unsubscribe(IObserver<DictionaryEvent<TKey, TValue>> observer)
        {
            throw new NotImplementedException();
        }
