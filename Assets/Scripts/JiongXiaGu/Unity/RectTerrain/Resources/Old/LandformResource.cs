...
//    public sealed class LandformRes
//    {
//        /// <summary>
//        /// 唯一标识ID;
//        /// </summary>
...
//    /// 地形资源序列化;
//    /// </summary>
//    public sealed class LandformResourceSerializer : ResourcesReader<LandformRes[], Dictionary<int, LandformRes>>
//    {
//        public LandformResourceSerializer(ISerializer<LandformRes[]> serializer, ResourcesSearcher resourceSearcher) : base(serializer, resourceSearcher)
//        {
//        }

//        protected override Dictionary<int, LandformRes> Combine(List<LandformRes[]> sources)
//        {
//            var dictionary = new Dictionary<int, LandformRes>();
...
//        protected override LandformRes[] Convert(Dictionary<int, LandformRes> result)
//        {
...
//    {
//        public LandformResourceLoadRequest(LandformRes landformResource, AssetBundle assetbundle)
//        {
//            this.landformResource = landformResource;
//            this.assetbundle = assetbundle;
//        }

//        readonly LandformRes landformResource;
