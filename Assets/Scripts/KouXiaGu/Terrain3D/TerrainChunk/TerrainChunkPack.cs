...
namespace KouXiaGu.Terrain3D
{
    ...
    public class TerrainChunkPack
    {
        ...
        /// 创建一个空的地图块到;
        /// </summary>
        public TerrainChunkPack()
        {
            GameObject gameobjct = CraeteTerrainChunk();
            Renderer = gameobjct.GetComponent<TerrainChunk>();
        ...
        public TerrainChunk Renderer { get; private set; }
