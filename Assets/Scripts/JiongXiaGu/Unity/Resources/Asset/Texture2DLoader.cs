...
namespace JiongXiaGu.Unity.Resources
{
    ...
    internal class Texture2DLoader : AssetLoader<Texture2D>
    {
        ...
        public override Task<Texture2D> LoadAsync(LoadableContent content, AssetInfo assetInfo, CancellationToken token)
        {
        ...
        /// 从 文件 读取 Texture2D;
        /// </summary>
        private static Texture2D FromFileLoadTexture2D(LoadableContent content, AssetInfo assetInfo)
        {
