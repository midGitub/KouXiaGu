...
//        private Task<LanguageGroup> readLanguagePackTask;
...
//        /// 读取到预定义的语言;
//        /// </summary>
//        private Task<LanguageGroup> ReadLanguagePack(CancellationToken token)
//        {
...
//                        LanguageGroup languagePackGroup = new LanguageGroup(targetPack);
