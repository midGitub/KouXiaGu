...
//    [Obsolete]
//    public class OTimeManager : IObservable<DateTime>, IObserver<IWorld>
//    {

//        public static IAsyncOperation<OTimeManager> Create(WorldTimeInfo info, IObservable<IWorld> world)
//        {
//            var item = new Operation<OTimeManager>(() => new OTimeManager(info, world));
//            item.Start();
//            return item;
//        }


//        public OTimeManager(WorldTimeInfo info, IObservable<IWorld> world)
//        {
//            InitCalendar();
//            Info = info;
...
//        {
//            public TimeUpdater(OTimeManager manager)
//                : base("更新世界时间")
//            {
