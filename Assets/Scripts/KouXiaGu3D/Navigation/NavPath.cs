...
namespace KouXiaGu.Navigation
{
    ...
    {
        public NavPath(LinkedList<CubicHexCoord> wayPath,
            IDictionary<CubicHexCoord, TerrainNode> worldMap)
        {
        ...
        /// 路径点合集;
        /// </summary>
        LinkedList<CubicHexCoord> wayPath;
        ...
        {
            get { return ConvertPoint(wayPath.First.Value); }
        }
        ...
        {
            get { return ConvertPoint(wayPath.Last.Value); }
        }
        ...
        /// 地图坐标转换成平面坐标;
        /// </summary>
        Vector3 ConvertPoint(CubicHexCoord mapPoint)
        {
            return GridConvert.Grid.GetPixel(mapPoint);
        }
