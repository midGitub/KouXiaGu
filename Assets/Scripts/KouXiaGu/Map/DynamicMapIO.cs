...
namespace KouXiaGu.Map
{
    ...
    public interface IDynamicMapIO<TMap, T>
        where TMap : IGameMap<ShortVector2, T>
    {
        string Save(TMap mapPaging);
        void SaveAsyn(TMap mapPaging);

        TMap Load(ShortVector2 address);
        bool TryLoad(ShortVector2 address, out TMap mapPaging);
    ...
    public class DynamicMapIO<T> : IDynamicMapIO<DynamicMapPaging<T>, T>
    {

        public DynamicMapIO(DynamicPagingInfo pagingInfo)
        {
