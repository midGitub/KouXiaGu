...
namespace KouXiaGu.RectTerrain
{
    ...
    public class LandformBakeDrawingBoardMesh : MonoBehaviour
    {
        ...
        static readonly float chunkHalfWidth = RectTerrainInfo.NodeWidth / 2 + (RectTerrainInfo.NodeWidth / 4);
        static readonly float chunkHalfHeight = RectTerrainInfo.NodeHeight / 2 + (RectTerrainInfo.NodeHeight / 4);
