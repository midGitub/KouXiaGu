...
namespace JiongXiaGu.Collections
{
    ...
    /// </summary>
    [Obsolete]
    public abstract class OBinaryHeap<T> : ICollection<T>, IEnumerable<T>
    {
        ...
        public OBinaryHeap(int capacity)
        {
        ...
        /// 深拷贝;
        /// </summary>
        public OBinaryHeap(OBinaryHeap<T> binaryHeap)
        {
    ...
    /// </summary>
    [Obsolete]
    public class MinHeap<T> : OBinaryHeap<T>
    ...
    /// </summary>
    [Obsolete]
    public class MaxHeap<T> : OBinaryHeap<T>
        where T : IComparable<T>
    {
        public MaxHeap() { }
